...
void ctr_example()
{
	...
	printf("\n");
	/* NOTE: the context (ctx) keeps track of the updated counter/IV for
	 * you which is nice when sending sequences of messages, as in the chat
	 * program (this way you don't have to generate and send a fresh IV for
	 * each message). */
